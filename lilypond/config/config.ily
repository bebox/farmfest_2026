...
farmfestColor = #(rgb-color 0.627451 0.207843 0.262745)
...
\layout {
  \context {
    ...
    \override BreathingSign.color = #farmfestColor
  }
  ...
  \context {
    ...
    \override RehearsalMark.color = #farmfestColor
  }
}
...
breathemoj = {
  ...
  \once \override Staff.BarLine.color = #farmfestColor
...
markMojPonn = {
  %\override Score.RehearsalMark.extra-spacing-width = #'(0 . 0)
  %\override Score.RehearsalMark.extra-spacing-height = #'(-inf.0 . +inf.0) 
  \once \override Score.RehearsalMark.X-offset = #4.3
  %\once \override Score.RehearsalMark.extra-spacing-height = #0
  %\once \override Score.RehearsalMark.outside-staff-priority = #1
  %\override Score.RehearsalMark.break-align-symbols = #'(breathing-sign)
  %\override Score.RehearsalMark.break-align-symbols = #'(breathing-sign)
    ...
    \fill-line { %rasiri po liniji u stupce na rubove
      \line { %stvori lijevu grupu stupaca
        ...
        { \vspace #1.5 %pomiče znak prema dole
          { \override #'(font-name . "JohnSans Medium Pro") \override #'(font-size . 13) \with-color #farmfestColor \fromproperty #'header:broj } }
...
\header {
  copyright = \markup { \override #'(font-name . "JohnSans White Pro") \override #'(font-size . -3) { Creative Commons—Attribution-ShareAlike 4.0 | Farmfest 2026 | Dravska 54, Poleve, Strahoninec } }
