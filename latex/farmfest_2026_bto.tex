\def\frontcoverpdf{images/ff2026_korice_prednja_bto.pdf}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/bez_ljubavi.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
   ...
   {../lilypond/bin_bto/bez_ljubavi.pdf}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/bog_je_moja_snaga.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/ime_isus.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/isus_nazarecanin.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/pastir_moje_duse.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/poziv.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/psalam_42.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,4.5){\includegraphics[width=\linewidth]{images/4.jpg}}}]%
   {../lilypond/bin_bto/psalam_42.pdf}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/to_dade_bog.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/tvoje_nebo.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/u_duhu_budite_gorljivi.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bto/vidjeh_oblak.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,6){\includegraphics[width=\linewidth]{images/8.jpg}}}]%
   {../lilypond/bin_bto/vidjeh_oblak.pdf}
