...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/bez_ljubavi.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
   ...
   {../lilypond/bin_c/bez_ljubavi.pdf}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/bog_je_moja_snaga.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/ime_isus.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/isus_nazarecanin.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/pastir_moje_duse.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/poziv.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/psalam_42.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,4.5){\includegraphics[width=\linewidth]{images/4.jpg}}}]%
   {../lilypond/bin_c/psalam_42.pdf}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/to_dade_bog.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/tvoje_nebo.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/u_duhu_budite_gorljivi.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_c/vidjeh_oblak.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,6){\includegraphics[width=\linewidth]{images/8.jpg}}}]%
   {../lilypond/bin_c/vidjeh_oblak.pdf}
