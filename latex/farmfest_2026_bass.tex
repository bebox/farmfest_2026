\def\frontcoverpdf{images/ff2026_korice_prednja_bass.pdf}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/bez_ljubavi.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
   ...
   {../lilypond/bin_bass/bez_ljubavi.pdf}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/bog_je_moja_snaga.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/ime_isus.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/isus_nazarecanin.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/pastir_moje_duse.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/poziv.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/psalam_42.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,4.5){\includegraphics[width=\linewidth]{images/4.jpg}}}]%
   {../lilypond/bin_bass/psalam_42.pdf}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/to_dade_bog.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/tvoje_nebo.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/u_duhu_budite_gorljivi.pdf}
\end{minipage}
...
\includepdf[pages={1},noautoscale]{../lilypond/bin_bass/vidjeh_oblak.pdf}
\end{minipage}
\newpage
\includepdf[pages={2},noautoscale,
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,6){\includegraphics[width=\linewidth]{images/8.jpg}}}]%
   {../lilypond/bin_bass/vidjeh_oblak.pdf}
